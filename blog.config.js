...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '363f945604c54864abe68376f604ebbd',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '天地不全，以上皆非',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tabor', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱吃巧克力曲奇的伪乐迷,仿影迷,假It🍪', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tabor.dynv6.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人博客,杂谈,音乐,电影,分享,私人空间', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'taborbb@163.com', // 邮箱地址 例如mail@tangly1024.com
...
'"LXGW WenKai"',
  ...
  PRISM_THEME_PREFIX_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-lucario.min.css', // 代码块默认主题
  ...
  COMMENT_VALINE_PLACEHOLDER:
        process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '别骂人就行', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
